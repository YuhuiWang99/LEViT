...
def adjust_contrast(img, contrast_factor):
    ...
    mean = cv2.cvtColor(img, cv2.COLOR_RGB2GRAY).mean() + 0.5
...
def rotate(img, angle, resample=False, expand=False, center=None, fill=0):
    ...
    if expand:
        ...
        dsize = (w * sin_angle + w * cos_angle, h * sin_angle + h * cos_angle)
    else:
        dsize = (w, h)
